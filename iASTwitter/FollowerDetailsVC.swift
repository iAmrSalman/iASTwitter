...
class FollowerDetailsVC: BaseViewController {
    ...
    @IBOutlet weak var kiraBtn: UIBarButtonItem!
    @IBOutlet weak var lBtn: UIBarButtonItem!
    ...
    override func setup() {
        ...
        if let font = UIFont(name: "DEATHNOTE-Font", size: 20) {
            kiraBtn.setTitleTextAttributes([NSAttributedString.Key.font: font], for: .normal)
            lBtn.setTitleTextAttributes([NSAttributedString.Key.font: font], for: .normal)
        }
